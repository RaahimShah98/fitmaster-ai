...
const UserDashboardMenu = ({ setSelectedPage }) => {
  ...
  return (
    <>
      ...
      {/* Sidebar Menu */}
      <div
        className={`sidebar fixed md:relative h-screen bg-gray-900 text-white transition-all duration-300 ease-in-out z-40 ${
          isMobile ? (isMenuOpen ? "left-0 w-64" : "-left-64 w-64") : "w-64"
        }`}
      >
        <div className="p-4">
          <div className="flex justify-evenly items-center">
            ...
            {isMobile && (
              <X
                className="relative bottom-2 left-8"
                size={24}
                onClick={() => setIsMenuOpen(!isMenuOpen)}
              />
            )}
            ...
            <ul className="space-y-4">
              ...
              <li>
                <button
                  ...
                  className={`w-full text-left py-2 px-4 rounded transition ${
                    activePage === "Goals" ? "bg-gray-600" : "hover:bg-gray-700"
                  }`}
                >
                  Goals
                </button>
              ...
              <li>
                <button
                  ...
                  className={`w-full text-left py-2 px-4 rounded transition ${
                    activePage === "workoutdisplay-page"
                      ? "bg-gray-600"
                      : "hover:bg-gray-700"
                  }`}
                >

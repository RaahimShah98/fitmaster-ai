...
const LoginForm = () => {
  ...
  return (
    <div className="flex min-h-screen w-full">
      ...
      <div className="flex flex-1 items-center justify-center p-4 md:p-8">
        <Card className="w-full max-w-md">
          ...
          <CardContent className="space-y-4">
            ...
            {invalid && (
              <span className="w-full flex justify-center bg-red-100 br-10 p-2">
                {error}
              </span>
            )}
            <form onSubmit={handleEmailLogin} className="space-y-4">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  className={`${
                    invalid && email.length == 0 ? "bg-red-200" : "bg-white"
                  } text-black`}
                  required
                />
              </div>
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <Button
                    ...
                    onClick={() => router.replace("/PasswordResetRequest")}
                  >
                    Forgot password?
                  </Button>
                </div>
      ...
      <div
        className="hidden md:flex flex-1 text-white bg-black bg-cover bg-center"
        ...
        <div className="flex flex-col items-center justify-center p-8 w-full bg-black bg-opacity-80">
          <div className="max-w-md">
            ...
            <p className="text-lg mb-6">
              Experience the next evolution of fitness with AI-powered guidance
              and real-time form correction.
            </p>

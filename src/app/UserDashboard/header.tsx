    ...
    <div className="w-full h-20 bg-blue-500 text-white flex items-center justify-between px-4">
      ...
      <div className="relative">
        <button
          ...
          className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-blue-800"
        >
          <img

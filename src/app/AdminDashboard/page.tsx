...
const AdminDashboard: React.FC = () => {
  ...
  const modelUsageData: ModelUsage[] = [
    { date: '2025-02-25', userCount: 1250, apiCalls: 18500, processingTime: 340 },
    { date: '2025-02-26', userCount: 1290, apiCalls: 19200, processingTime: 355 },
    { date: '2025-02-27', userCount: 1310, apiCalls: 20100, processingTime: 362 },
    { date: '2025-02-28', userCount: 1340, apiCalls: 19800, processingTime: 348 },
    { date: '2025-03-01', userCount: 1420, apiCalls: 21500, processingTime: 375 },
    { date: '2025-03-02', userCount: 1480, apiCalls: 22300, processingTime: 389 },
    { date: '2025-03-03', userCount: 1510, apiCalls: 23100, processingTime: 396 },
  ];
      ...
      <div className={`${sidebarOpen ? 'block' : 'hidden'} fixed inset-0 z-40 lg:hidden`}>
        ...
        <div className="fixed inset-y-0 left-0 flex flex-col w-64 max-w-xs bg-gray-800 border-r border-gray-700">
          ...
          <nav className="flex-1 px-2 py-4 space-y-1">
            <Link href="#" className="flex items-center px-2 py-2 text-sm font-medium rounded-md bg-purple-700 text-white">
              <UsersIcon className="mr-3 h-5 w-5" />
              Dashboard
            </Link>
            <Link href="#" className="flex items-center px-2 py-2 text-sm font-medium rounded-md text-gray-300 hover:bg-gray-700 hover:text-white">
              <UsersIcon className="mr-3 h-5 w-5" />
              Users
            </Link>
            <Link href="#" className="flex items-center px-2 py-2 text-sm font-medium rounded-md text-gray-300 hover:bg-gray-700 hover:text-white">
      ...
      <div className="flex flex-col flex-1 overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto bg-gray-900 p-6">
            ...
            <div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="bg-gray-800 rounded-lg p-6 border border-gray-700 col-span-1 lg:col-span-2">
                  <h3 className="text-lg font-medium text-gray-300 mb-4">Recent User Activity</h3>
                        ...
                        {users.slice(0, 5).map((user) => (
                          <tr key={user.id}>
                            ...
                            <td className="px-6 py-4 whitespace-nowrap">
                              ...
                              <div className="text-xs text-gray-400 mt-1">{user.progress}% Complete</div>
                            </td>
                          </tr>
                        ))}
                      </tbody>
          ...
          {currentTab === 'model' && (
            <div>
              <div className="mb-6">
                <h2 className="text-xl font-semibold mb-4">AI Model Usage Analytics</h2>
                        ...
                        datasets: [
                          {
                            ...
                            data: modelUsageData.map(data => data.processingTime),
                            borderColor: '#6366f1',
                  ...
                  <table className="min-w-full divide-y divide-gray-700">
                    <thead className="bg-gray-700">
                      <tr>
                        ...
                        <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-gray-300 uppercase tracking-wider">API Calls</th>
                        <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-gray-300 uppercase tracking-wider">Avg. Processing Time</th>
                      </tr>
                    </thead>
                    <tbody className="bg-gray-800 divide-y divide-gray-700">
                      {modelUsageData.map((data, index) => (
                        <tr key={index}>
                          <td className="px-6 py-4 whitespace-nowrap text-sm">{data.date}</td>
                          <td className="px-6 py-4 whitespace-nowrap text-sm">{data.userCount.toLocaleString()}</td>
                          <td className="px-6 py-4 whitespace-nowrap text-sm">{data.apiCalls.toLocaleString()}</td>
                          <td className="px-6 py-4 whitespace-nowrap text-sm">{data.processingTime} ms</td>
                        </tr>
                      ))}
                    </tbody>
                  </table>
          ...
          <div className="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div className="inline-block align-bottom bg-gray-800 rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
              <div className="px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                <h3 className="text-lg font-medium text-gray-100">{modalMode === 'add' ? 'Add New User' : 'Edit User'}</h3>
